...
export function HomePageContent() {
  ...
  const feedPosts = [
    { id: 'popup-reset-card', src: 'https://i.postimg.cc/mD3Jt5wz/kamy03-2.jpg', likes: 1248, comments: 126 },
    { id: undefined, src: 'https://i.postimg.cc/DwxfFbm0/kamy02.gif', likes: 2312, comments: 88 },
    { id: undefined, src: 'https://i.postimg.cc/7Z6ZPRZh/kamy03-1.jpg', likes: 889, comments: 45 },
